...
const DICT: Dict = {
  ...
  "cust.f.address": { en: "Street Address", zh: "街道地址" },
  "cust.f.unit": { en: "Unit / Apt", zh: "单元 / 公寓" },
  "cust.f.suite": { en: "Suite", zh: "套房号" },
  "cust.f.building": { en: "Building", zh: "楼栋" },
  "cust.f.city": { en: "City", zh: "城市" },
  "cust.f.state": { en: "State", zh: "州" },
  "cust.f.zip": { en: "ZIP Code", zh: "邮编" },
  "cust.f.country": { en: "Country", zh: "国家" },
  ...
  "pb.add.title": { en: "Add Price Item", zh: "新增价格项目" },
  "pb.fab.add": { en: "Add Item", zh: "增加新条目" },
  "pb.fab.import": { en: "Import Excel", zh: "导入 Excel" },
  "pb.fab.export": { en: "Export Excel", zh: "导出 Excel" },
  "pb.import.preview": { en: "Import Preview", zh: "导入预览" },
  "pb.import.valid": { en: "Valid", zh: "有效" },
  "pb.import.invalid": { en: "Invalid", zh: "无效" },
  "pb.import.confirm": { en: "Confirm Import", zh: "确认导入" },
